...
# how to have request spans be children of application spans.
#
...
class TyphoeusMiniAppTest < Minitest::Test
  ...
  def test_miniapp
    ...
    pin = Datadog::Pin.get_from(request) # get a ref to the HTTP PIN
